                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="email_participante" type="email" class="form-control" required name="email" maxlength="50">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
        ...
        $(function(){
            ...
            $('#btnSalvarParticipante').click(function(){
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {_token: CSRF_TOKEN, id: id_participante, nome: nome_participante, email: email_participante,
                        cpf: cpf_participante, celular: wpp_participante},
                    success: function(data){
                        console.log(data);
