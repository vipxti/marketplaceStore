...
@section('content')
        ...
        <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        <h1><i class="fa fa-th-large"></i>&nbsp;&nbsp;Configuração da Vitrine</h1>
                        <ol class="breadcrumb">
                            ...
                            <section class="content">
                                <div class="box box-primary">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Quantidade de Produtos</h3>
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            <form action="{{ route('produtos.vitrine.page') }}" method="post">
                                                {{ csrf_field() }}
                                                <button type="submit" class="btn btn-group pull-right"><i class="fa fa-save"></i>&nbsp;&nbsp;Salvar</button>
